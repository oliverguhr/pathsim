"use strict";
const index_1 = require("./algorithm/index");
const index_2 = require("./Grid/index");
const MazeGenerator_1 = require("./MazeGenerator");
const PathCostVisualizer_1 = require("./PathCostVisualizer");
const ObstacleGenerator_1 = require("./ObstacleGenerator");
const DynmicObstacleGenerator_1 = require("./DynmicObstacleGenerator");
const angular = require("angular");
exports.app = angular.module("pathsim", []);
exports.app.controller('MapController', function ($attrs, $interval) {
    var map = this;
    map.name = "test";
    map.cols = $attrs.cols;
    map.rows = $attrs.rows;
